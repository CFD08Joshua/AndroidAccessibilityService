...
public class VerticalSeekBar extends AppCompatSeekBar {
    ...
    private ISeekBarCallBack iSeekBarCallBack;
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        //  widthMeasureSpec 與 heightMeasureSpec 交換
        super.onMeasure(heightMeasureSpec, widthMeasureSpec);
        //  getMeasuredWidth 與 getMeasuredHeight 交換
    ...
    protected void onVisibilityChanged(@NonNull View changedView, int visibility) {
        ...
        if (View.GONE == visibility && iSeekBarCallBack != null) {
            iSeekBarCallBack.onSeekBarDetached();
        }
    }
    ...
    public void setCallback(ISeekBarCallBack callback) {
        iSeekBarCallBack = callback;
    }
