...
import com.example.androidaccessibilityservice.service.MyAccessibilityService;
...
public class SideBarArrow implements View.OnClickListener {
    ...
    private MyAccessibilityService mSideBarService;
    private SideBarContent mContentBar;
    private LinearLayout mContentBarView;
    private LinearLayout mAnotherArrowView;

    public LinearLayout getView(Context context, boolean left, WindowManager windowManager, MyAccessibilityService sideBarService) {
        mContext = context;
        mLeft = left;
