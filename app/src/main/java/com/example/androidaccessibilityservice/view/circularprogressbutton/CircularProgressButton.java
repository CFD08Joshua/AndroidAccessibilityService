...
import com.example.androidaccessibilityservice.util.Utils;
import com.example.androidaccessibilityservice.util.UtilsJava;
import com.example.androidaccessibilityservice.view.circularprogressbutton.AnimatedButton;
...
public class CircularProgressButton  extends AppCompatButton implements AnimatedButton, CustomizableByCode {
    ...
    private CircularProgressParams mParams;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        mParams = new CircularProgressParams();
